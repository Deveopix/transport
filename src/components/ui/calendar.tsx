...
function DateField(props: AriaDatePickerProps<DateValue>) {
	...
	return (
		<div
			...
			ref={ref}
			className={cn(
				"inline-flex h-10 flex-1 items-center justify-end rounded-l-md border-input bg-transparent px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
...
function TimeField(props: AriaTimeFieldProps<TimeValue>) {
	...
	return (
		<div
			...
			ref={ref}
			className={cn(
				"inline-flex h-10 w-full flex-1 justify-end rounded-md border border-input bg-transparent px-3 py-2 text-sm ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
				props.isDisabled && "cursor-not-allowed opacity-50",
			)}
		>
			{state.segments.map((segment, i) => (
